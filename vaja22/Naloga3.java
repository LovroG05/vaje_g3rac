public class Naloga3 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Pravilno rešen in %s procentni sudoku.\n", isPercent() ? "je" : "ni");
	}
	...
	private static boolean isPercent() {
		...
		for(int i = 0; i < SUDOKU.length; i++) {
			tabela[SUDOKU[SUDOKU.length - i - 1][i] - 1] = true;
		}

		boolean delHyper = checkRange(new Point(1, 1), new Point(3, 3)) &&
				checkRange(new Point(5, 5), new Point(7, 7));

		return vseStevke(tabela) && delHyper;
	}
